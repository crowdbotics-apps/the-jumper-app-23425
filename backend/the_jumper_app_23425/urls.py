"""the_jumper_app_23425 URL Configuration
...
admin.site.site_header = "the jumper app"
admin.site.site_title = "the jumper app Admin Portal"
admin.site.index_title = "the jumper app Admin"

# swagger
api_info = openapi.Info(
    title="the jumper app API",
    default_version="v1",
    description="API documentation for the jumper app App",
)
